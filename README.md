...
도구 접근 제한에 대비한 대안은 이미지 생성 `GPT Image 2`, 비디오 생성 `Veo 3.1`, 음성 생성 `TTS-1 HD`로 설정했습니다. 이 가운데 Veo 3.1은 실제 비교본 제작에 사용했고, 네이토 환경의 TTS도 별도로 시험했습니다. GPT Image 2는 사용하지 않았습니다.
